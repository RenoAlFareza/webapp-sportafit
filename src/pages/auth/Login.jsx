...
function Login() {
  ...
  // Untuk demo, tambahkan fungsi login dengan data dummy
  const handleDemoLogin = () => {
    // Simpan data user dummy di localStorage
    const dummyUser = {
      id: "user123",
      name: "Fajar Nugros",
    ...
    // Refresh halaman agar AuthContext memuat data user dari localStorage
